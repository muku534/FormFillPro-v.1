window.FieldDetector = {
    patterns: {
        ...
        gender: { attributes: ['gender', 'sex', 'gender-identity'], validFor: ['select', 'input'], autocomplete: ['sex'] },
        veteranStatus: { attributes: ['veteran', 'military', 'vet-status', 'veteran-status', 'military-status'], validFor: ['select', 'input'], autocomplete: [] },
        ethnicity: { attributes: ['ethnicity', 'race', 'ethnic-group', 'race-ethnicity'], validFor: ['select', 'input'], autocomplete: [] },
        disabilityStatus: { attributes: ['disability', 'handicapped', 'disability-status'], validFor: ['select', 'input'], autocomplete: [] },
